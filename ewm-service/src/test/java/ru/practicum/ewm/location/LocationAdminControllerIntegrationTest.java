...
import ru.practicum.ewm.location.controller.LocationController;
...
class LocationAdminControllerIntegrationTest {
    ...
    void saveLocation_whenLocationValid_thenSavedLocation() {
        when(locationService.saveLocation(any(LocationDto.class))).thenReturn(locationDto);
    ...
    void saveLocation_whenLocationNotSaves_thenReturnedBadRequest() {
        ...
        when(locationService.saveLocation(any(LocationDto.class))).thenThrow(exception);
    ...
    void deleteLocationById_whenInvoked_thenDeletedLocation() {
        long locId = 0L;
        when(locationService.deleteLocationById(anyLong())).thenReturn(true);
        ...
        verify(locationService, times(1)).deleteLocationById(anyLong());
    }
